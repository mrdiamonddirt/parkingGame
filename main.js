(() => {
    ...
    var Qi = (i, t) => {
        for (var l in t) jt(i, l, { get: t[l], enumerable: true });
    };
    ...
    var Zi = (() => {
        for (var i = new Uint8Array(128), t = 0; t < 64; t++)
            i[
                t < 26 ? t + 65 : t < 52 ? t + 71 : t < 62 ? t - 4 : t * 4 - 205
            ] = t;
        return (l) => {
            for (
                var w = l.length,
    ...
    var R = class {
        ...
        invert() {
            ...
            (t[0] = this.m[5] * l - this.m[6] * w + this.m[7] * U),
                ...
                (t[10] = this.m[0] * cn - this.m[1] * X + this.m[3] * xt),
                (t[14] = -(this.m[0] * j - this.m[1] * $ + this.m[2] * xt)),
                (t[3] = -(this.m[1] * vt - this.m[2] * Se + this.m[3] * Ce)),
                (t[7] = this.m[0] * vt - this.m[2] * Re + this.m[3] * J),
                (t[11] = -(this.m[0] * Se - this.m[1] * Re + this.m[3] * Xe)),
                (t[15] = this.m[0] * Ce - this.m[1] * J + this.m[2] * Xe);
            let Et =
                this.m[0] * t[0] +
                this.m[1] * t[4] +
                this.m[2] * t[8] +
            ...
            for (let We = 0; We < 4; We++)
                for (let Me = 0; Me < 4; Me++) t[We * 4 + Me] *= 1 / Et;
            return new R(t);
        }
        toString() {
        ...
        gen(...t) {
            ...
            if (t.length === 1) {
                ...
                if (t[0] instanceof L && t[1] instanceof L)
                    return f(
                        this.gen(t[0].x, t[1].x),
                        this.gen(t[0].y, t[1].y)
                    );
    ...
    a(vr, "testLineCircle");
    function Ne(i, t) {
        if (Ee(t, i.p1) || Ee(t, i.p2)) return true;
        for (let l = 0; l < t.length; l++) {
            let w = t[l],
                U = t[(l + 1) % t.length];
            if (he(i, { p1: w, p2: U })) return true;
        }
        return false;
    }
...
`;
    ...
    var ao = a((i = {}) => {
        let t = (() => {
            ...
            l = (() => {
                ...
                e.bindBuffer(e.ARRAY_BUFFER, c),
                    e.vertexAttribPointer(0, 3, e.FLOAT, false, Ye * 4, 0),
                    e.enableVertexAttribArray(0),
                    e.vertexAttribPointer(1, 2, e.FLOAT, false, Ye * 4, 12),
                    e.enableVertexAttribArray(1),
                    e.vertexAttribPointer(2, 4, e.FLOAT, false, Ye * 4, 20),
                ...
                let o = He(
                    new ImageData(
                        new Uint8ClampedArray([
                            128, 128, 128, 255, 190, 190, 190, 255, 190, 190,
                            190, 255, 128, 128, 128, 255,
                        ]),
                        2,
                        2
                    ),
        ...
        function _r(e) {
            return (
                e !== void 0 && (w.masterNode.gain.value = z2(e, Ar, Or)),
        ...
        function Ke(
            e,
            n = { loop: false, volume: 1, speed: 1, detune: 0, seek: 0 }
        ) {
            var g;
            if (typeof e == "string") {
                let y = Ke({ buf: Fr() });
            ...
            let d = r.currentTime - o,
                ...
                m = {
                    ...
                    speed(y) {
                        return (
                            y !== void 0 &&
                                (c.playbackRate.value = z2(y, ps, ms)),
                            c.playbackRate.value
                        );
                    },
                    detune(y) {
                        return c.detune
                            ? (y !== void 0 && (c.detune.value = z2(y, ws, gs)),
                              c.detune.value)
                            : 0;
                    },
                    volume(y) {
                        return (
                            y !== void 0 && (s.gain.value = z2(y, Ar, Or)),
                            s.gain.value
                        );
                    },
                    loop() {
...
`)
        ...
        function Tt(e, n, r, u = l.defTex, c = l.defShader, s = {}) {
            (u = u != null ? u : l.defTex),
                ...
                (u !== l.curTex ||
                    c !== l.curShader ||
                    !Yt(l.curUniform, s) ||
                    l.vqueue.length + e.length * Ye > bt ||
        ...
        function I(...e) {
            ...
            let n = f(...e);
            (n.x === 0 && n.y === 0) ||
                (l.transform = l.transform.translate(n));
        }
        a(I, "pushTranslate");
        function ne(...e) {
            if (e[0] === void 0) return;
        ...
        a(re, "pushTransform");
        function ie() {
            l.transformStack.length > 0 &&
                (l.transform = l.transformStack.pop());
        }
        a(ie, "popTransform");
        function me(e) {
            var h;
        ...
        function we(e) {
            ...
            let { charStyleMap: r, text: u } = Yr(e.text + ""),
                c = u.split(""),
                s = n.qw * n.tex.width,
                o = n.qh * n.tex.height,
                d = e.size || o,
...
` && (M.push(oe), (y += m), oe === " " && (ee = M.length)),
        ...
        a(G, "height"),
            ...
            t.canvas.addEventListener("keydown", (e) => {
                ...
                ds.includes(n) && e.preventDefault(),
                    n.length === 1 && t.charInputted.push(e.key),
                    n === "space" && t.charInputted.push(" "),
                    e.repeat
                        ? ((t.isKeyPressedRepeat = true),
                          (t.keyStates[n] = "rpressed"))
                        : ((t.isKeyPressed = true),
                          (t.keyStates[n] = "pressed"));
            }),
        ...
        function et(e = "left") {
            return (
                t.mouseStates[e] === "pressed" || t.mouseStates[e] === "down"
            );
        }
        a(et, "isMouseDown");
        function tt(e = "left") {
        ...
        let C = {
            ...
            error: (e) =>
                p.logs.unshift(`[${rt().toFixed(2)}].time [${e}].error`),
            curRecording: null,
            get paused() {
                return t.paused;
            },
            ...
            let n = /* @__PURE__ */ new Map(),
                ...
                c = {
                    ...
                    add(s) {
                        if (this !== p.root)
                            throw new Error(
                                "Children game object not supported yet"
                            );
                        let o = Sn(s);
                        return (
                            (o.parent = this),
                    ...
                    is(s) {
                        if (s === "*") return true;
                        if (Array.isArray(s)) {
                            for (let o of s) if (!this.c(o)) return false;
                            return true;
        ...
        function st(...e) {
            return {
                    ...
                    if (
                        ...
                        p.root.every((h) => {
                            ...
                            if (
                                ...
                                h === this ||
                                !h.solid ||
                                ((ke = h.area) == null ? void 0 : ke.shape) !==
                                    "rect"
                            )
                                return;
                            let m = h.worldArea(),
                ...
                inspect() {
                    return `(${Math.round(this.pos.x)}, ${Math.round(
                        this.pos.y
                    )})`;
                },
            };
        ...
        function It(e = {}) {
            ...
            return {
                ...
                update() {
                    if (this.isOutOfView()) {
                        if (
                            (r || (this.trigger("exitView"), (r = true)),
                            e.delay && ((n += Z()), n < e.delay))
                        )
                            return;
                        e.hide && (this.hidden = true),
                            e.pause && (this.paused = true),
                            e.destroy && this.destroy();
                    } else
                        r && (this.trigger("enterView"), (r = false)),
                            (n = 0),
                            e.hide && (this.hidden = false),
                            e.pause && (this.paused = false);
                },
                inspect() {
        ...
        function hi(e = {}) {
            return typeof e == "number"
                ? (B("clean(time)", "cleanup({ delay: time })"),
                  D(P({}, It({ destroy: true, delay: e })), { id: "cleanup" }))
                : D(
                      P(
                          {},
                          It({
        ...
        function di(e = {}) {
            ...
            return {
                ...
                add() {
                    this.area.cursor &&
                        this.onHover(() => En(this.area.cursor));
                },
                area: {
                    shape: "rect",
                ...
                isColliding(c) {
                    if (!c.area || !c.exists()) return false;
        ...
        function fi(e, n = {}) {
            function r(u) {
                ...
                return (
                    (u.width =
                        c.width /
                        (((s = u.scale) == null ? void 0 : s.x) || 1)),
                    (u.height =
                        c.height /
                        (((o = u.scale) == null ? void 0 : o.y) || 1)),
                    c
                );
            }
            return (
        ...
        function pi(e, n, r = {}) {
            return {
                ...
                inspect() {
                    return `${Math.ceil(this.width)}, ${Math.ceil(
                        this.height
                    )}`;
                },
            };
                        ...
                        if (g)
                            if (g.isBottom()) {
                                ...
                                (n = 0),
                                    r.pos && (u = r.pos.clone()),
                                    h ||
                                        (this.trigger("ground", r), (c = true));
                            } else
                                g.isTop() &&
                                    ((n = 0),
                                    this.trigger("headbutt", g.target));
                        (n += Gn() * this.weight * Z()),
                            (n = Math.min(n, (m = e.maxVel) != null ? m : yi));
                    }
                },
                curPlatform() {
                    return r;
        ...
        function zn() {
            p.trigger("updateStart"),
                p.timers.forEach((e, n) => {
                    (e.time -= Z()),
                        e.time <= 0 && (e.action(), p.timers.delete(n));
                }),
                p.root.update();
        }
        a(zn, "updateFrame");
        ...
        function Gi() {
            let e = A();
            if (e === 1) (t.loaded = true), p.trigger("load");
            else {
                let n = F() / 2,
                    r = 24 / t.scale,
        ...
        function Qn() {
            ...
            if (C.inspect) {
                let r = null,
                    u = v.fromArray(
                        (e = i.inspectColor) != null ? e : [0, 0, 255]
                    );
                if (
                    (p.root.every((c) => {
